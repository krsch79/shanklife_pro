...
class User(db.Model):
    ...
    notify_balletour_round_started = db.Column(db.Boolean, nullable=False, default=True)
    notify_balletour_round_finished = db.Column(db.Boolean, nullable=False, default=True)
    notify_shanklife_round_started = db.Column(db.Boolean, nullable=False, default=True)
    notify_shanklife_round_finished = db.Column(db.Boolean, nullable=False, default=True)
    ...
    golfbox_username = db.Column(db.String(255), nullable=True)
    golfbox_password_token = db.Column(db.Text, nullable=True)
...
class GolfBoxRecurringBooking(db.Model):
    __tablename__ = "golfbox_recurring_bookings"

    id = db.Column(db.Integer, primary_key=True)
    created_by_user_id = db.Column(db.Integer, db.ForeignKey("users.id"), nullable=False)
    status = db.Column(db.String(30), nullable=False, default="active")
    course = db.Column(db.String(120), nullable=False)
    play_weekday = db.Column(db.Integer, nullable=False)
...
class AiFixRequest(db.Model):
    ...
    github_issue_state = db.Column(db.String(30), nullable=True)
    github_issue_labels = db.Column(db.Text, nullable=True)
...
class Round(db.Model):
    ...
    starting_hole_number = db.Column(db.Integer, nullable=True)
